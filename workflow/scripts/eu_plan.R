...
plan <- drake_plan(
  ...
  use_python("/home/adrian/anaconda3/bin/python")
  reticulate::import("pandas")
  source_python("scripts/pycaching-eu-descriptions.py"),
  system2("scripts/pycaching-eu-descriptions.py ./data/gc-list-eu-unfiltered.csv"),
