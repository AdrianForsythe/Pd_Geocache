...
set_target_properties(GEOS::geos PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgeos.so.3.11.0"
  IMPORTED_SONAME_RELEASE "libgeos.so.3.11.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS GEOS::geos )
list(APPEND _IMPORT_CHECK_FILES_FOR_GEOS::geos "${_IMPORT_PREFIX}/lib/libgeos.so.3.11.0" )
...
set_target_properties(GEOS::geos_c PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libgeos_c.so.1.17.0"
  IMPORTED_SONAME_RELEASE "libgeos_c.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS GEOS::geos_c )
list(APPEND _IMPORT_CHECK_FILES_FOR_GEOS::geos_c "${_IMPORT_PREFIX}/lib/libgeos_c.so.1.17.0" )
